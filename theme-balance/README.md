# Thème Balance — personnalisations GEMEA

Fichiers versionnés du thème **Balance** (non publié) de gemeajewels.com.

| Fichier | Rôle |
| --- | --- |
| `templates/product.json` | Gabarit de la page produit (9 sections) |
